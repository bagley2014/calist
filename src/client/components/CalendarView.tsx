...
export function CalendarView({ items, month, activeDay, onPrevMonth, onNextMonth, onToday, onSelectDay }: CalendarViewProps) {
          ...
          return (
            ...
            >
              ...
              <div className="calendar-day__chips">
                ...
                {dayItems.length > 3 ? <span className="calendar-chip calendar-chip--overflow">+{dayItems.length - 3}</span> : null}
              </div>
            </button>
          );
        })}
